...
class ExercisesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create exercise" do
    assert_difference('Exercise.count') do
      post exercises_url, params: { exercise: { lesson_id: @exercise.lesson_id, status: @exercise.status } }
    end
  ...
  test "should update exercise" do
    patch exercise_url(@exercise), params: { exercise: { lesson_id: @exercise.lesson_id, status: @exercise.status } }
